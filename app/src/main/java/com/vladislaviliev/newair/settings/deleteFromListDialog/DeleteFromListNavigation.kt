package com.vladislaviliev.newair.settings.deleteFromListDialog
...
private fun Content(onDismissRequest: () -> Unit) {
    ...
    val onConfirm = { c: Collection<Int> -> viewModel.delete(c); onDismissRequest() }
    DeleteFromListDialog(items, onConfirm, onDismissRequest)
}
