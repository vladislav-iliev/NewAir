...
import com.vladislaviliev.newair.home.mainScreen.state.HomeScreenStateUnspecified
import com.vladislaviliev.newair.home.mainScreen.state.HomeScreenStateTransformers
...
class HomeViewModel @Inject constructor(
    ...
    ).stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), HomeScreenStateUnspecified.value)
